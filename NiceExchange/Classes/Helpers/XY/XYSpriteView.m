...
- (NSMutableArray *)allFilesAtPath:(NSString *)direString type:(NSString*)fileType
{
    ...
    NSString *str = [XYSpriteView dataFilePath:direString ofType:filePathOption_app];
    ...
    for (NSString *fileName in tempArray) {
        ...
        NSString *fullPath = [XYSpriteView dataFilePath:path ofType:filePathOption_app];
...
- (void) showImgWithIndex:(NSInteger)index{
    ...
    NSString *path = [XYSpriteView dataFilePath:tmpStr ofType:filePathOption_app];
