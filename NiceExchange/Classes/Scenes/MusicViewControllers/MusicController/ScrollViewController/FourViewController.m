...
- (void)viewDidLoad {
    ...
    [self fiveMusicRequest];
}



//请求数据
- (void)fiveMusicRequest
{
    ...
    [request fiveScrollRequestparameter:nil success:^(NSDictionary *dic) {
        
        [self.imageV setImageWithURL:[NSURL URLWithString:dic[@"pic_300"]]];
