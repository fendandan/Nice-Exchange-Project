...
@interface OneScrollViewController ()
<
...
@implementation OneScrollViewController
...
- (void)twoMusicRequest
{
    ...
    [request twoScrollRequestparameter:nil success:^(NSDictionary *dic) {
